...
export default function Tokenomics(){
    return(
        <section className="relative z-30 bg-white _section  pt-[10px]">
            ...
            <div data-aos="zoom-in" data-aos-duration="2000" className="absolute -z-10 top-0 left-[10px] 2xl:left-[calc((100%-1440px)/2)] w-[calc(100%-20px)] max-w-[1440px] h-full bg-[#F5F5F5] rounded-[10px]"></div>
            ...
            <div id="Tokenomics" className="_wrapper">
                <div className="py-[30px] md:py-[60px]">
                    ...
                    <div data-aos="zoom-in" data-aos-duration="2000" className='w-full overflow-hidden mt-[5%] px-5 text-center font-medium cursor-pointer '>
                        Total Supply:<br/>
                        <span className='text-[12px] md:text-[16px]'>21,000,000,000 WB</span>
                    </div>
