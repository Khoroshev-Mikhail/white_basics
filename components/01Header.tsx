...
export default function Header(){
    ...
    return(
        <section ref={ref} id="Header" className="_section  relative min-h-lvh  bg-black overflow-hidden ">
            <div className="relative z-20 w-full h-full min-h-lvh flex  pt-[44px] xs:pt-[51px] md:pt-[70px] overflow-hidden">
                ...
                <div className={`relative z-20 w-full md:w-[2/3] h-full px-2 overflow-hidden my-auto flex flex-col  rounded-[10px]`}>
